...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-352e-adc2-7639-d6a9" name="Warhammer 40,000 10th Edition" revision="87" battleScribeVersion="2.03" type="gameSystem">
  <publications>
      ...
      <categoryLinks>
        ...
        <categoryLink name="Monster" hidden="false" id="8eef-7007-d7a2-a968" targetId="9693-cf84-fe69-37a9" primary="false">
          <modifiers>
            <modifier type="set" value="true" field="hidden">
              <conditions>
                <condition type="instanceOf" value="1" field="selections" scope="ancestor" childId="bdc0-c0d-72d7-87e2" shared="true" id="excludeVehiclesFromCharacters"/>
              </conditions>
            </modifier>
          </modifiers>
        </categoryLink>
      ...
      <selectionEntryGroups>
        <selectionEntryGroup name="Main Rules Battle Scars" id="39da-ebb3-1551-dd9e" hidden="false">
          <selectionEntries>
            ...
            <comment>Infantry Scars</comment>
            <selectionEntry type="upgrade" import="true" name="Deep Wounds" hidden="false" id="856a-44c0-4d44-4fd6">
              <constraints>
              ...
              <profiles>
                <profile name="Deep Wounds" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
            ...
            <selectionEntry type="upgrade" import="true" name="Weak Swing" hidden="false" id="Weak Swing">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
            ...
            <selectionEntry type="upgrade" import="true" name="Slowed" hidden="false" id="Slowed">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Slowed" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">Unit’s movement is reduced by 1”</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <modifierGroups>
                <modifierGroup type="and">
                  <modifiers>
                    <modifier type="append" value="Slowed" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Unit"/>
                    <modifier type="increment" value="-1" field="e703-ecb6-5ce7-aec1" scope="model" affects="self.entries.recursive.profiles.Unit" join=", "/>
                  </modifiers>
                </modifierGroup>
              </modifierGroups>
              <costs>
            ...
            <selectionEntry type="upgrade" import="true" name="Underpowered Shot" hidden="false" id="Underpowered-Shot">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Underpowered Shot" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">All ranged weapons this unit have their AP worsened by one  (to a max of -0).</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <modifierGroups>
            ...
            <comment>Vehicle Scars</comment>
            <selectionEntry type="upgrade" import="true" name="Broken Engine" hidden="false" id="Broken-Engine">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Broken Engine" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">Decrease the movement of this unit by 2”.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <modifierGroups>
                <modifierGroup type="and">
                  <modifiers>
                    <modifier type="append" value="Broken Engine" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Unit"/>
            ...
            <comment>Character Scars</comment>
            <selectionEntry type="upgrade" import="true" name="Chaotic Leadership" hidden="false" id="Chaotic-Leadership">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Chaotic Leadership" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">Reduce the Leadership of this model and any attached unit by 2, and when this unit fails a battleshock test they take d3 mortal wounds.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <modifierGroups>
                <modifierGroup type="and">
                  <modifiers>
                    <modifier type="append" value="Chaotic Leadership" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Unit"/>
                    <modifier type="increment" value="2" field="58d2-b879-49c7-43bc" scope="model" affects="self.entries.recursive.profiles.Unit" join=", "/>
                  </modifiers>
                </modifierGroup>
              </modifierGroups>
              <costs>
            ...
            <selectionEntry type="upgrade" import="true" name="Damnation" hidden="false" id="Damnation">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Damnation" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">All [Psychic] weapons have [Precision] when targeting this unit.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
            ...
            <selectionEntry type="upgrade" import="true" name="Fractured Defences" hidden="false" id="Fractured-Defences">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Fractured Defences" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">Worsen all saves (armour or invulnerable) by 1 to a max of +6.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <modifierGroups>
                <modifierGroup type="and">
                  <modifiers>
                    <modifier type="append" value="Fractured Defences" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Unit"/>
                    <modifier type="increment" value="1" field="450-a17e-9d5e-29da" scope="model" affects="self.entries.recursive.profiles.Unit" join=", "/>
                  </modifiers>
                </modifierGroup>
              </modifierGroups>
            ...
            <selectionEntry type="upgrade" import="true" name="Poisoned Wounds" hidden="false" id="Poisoned-Wounds">
              ...
              <profiles>
                <profile name="Poisoned Wounds" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">Reduce the wounds of this unit by 1 (to a minimum of 1).</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <modifierGroups>
                <modifierGroup type="and">
                  <modifiers>
                    <modifier type="append" value="Poisoned Wounds" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Unit"/>
            ...
            <selectionEntry type="upgrade" import="true" name="Corrupted Weapons" hidden="false" id="Corrupted-Weapons">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Corrupted Weapons" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">Worsen the the Weapon Skill and Ballistic Skill of this model by 1 (to a minimum of 6+).</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <modifierGroups>
                <modifierGroup type="and">
                  <comment>Corrupted Weapons</comment>
                  <modifiers>
                    <modifier type="append" value="Corrupted Weapons" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Ranged Weapons"/>
                    <modifier type="increment" value="1" field="94d-8a98-cf90-183e" scope="model" affects="self.entries.recursive.profiles.Ranged Weapons"/>
                    <modifier type="append" value="Corrupted Weapons" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Melee Weapons"/>
                    <modifier type="increment" value="1" field="95d1-95f-45b4-11d6" scope="model" affects="self.entries.recursive.profiles.Melee Weapons"/>
                  </modifiers>
                </modifierGroup>
              </modifierGroups>
            ...
            <selectionEntry type="upgrade" import="true" name="Fate Cursed" hidden="false" id="Fate-Cursed">
              <constraints>
                <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="ed4f-7458-34ff-ae92" includeChildSelections="false"/>
              </constraints>
              <profiles>
                <profile name="Fate Cursed" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="4889-1296-cec0-fdbe">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">This model may not make any re-rolls for any reason.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
      ...
      <!-- ********************************************************************************************** -->
        ...
        <selectionEntryGroup name="Ferrus Crusade Battle Traits" id="b6e6-7945-adcc-eb15" hidden="false" collapsible="true">
          <selectionEntries>
            ...
            <selectionEntry type="upgrade" import="true" name="Thundering Onslaught" hidden="false" id="517e-58d9-dfec-c800">
              <constraints>
              ...
              <profiles>
                <profile name="Thundering Onslaught" typeId="9cc3-6d83-4dd3-9b64" typeName="Abilities" hidden="false" id="d14a-3cde-c35d-fa13">
                  <characteristics>
                    <characteristic name="Description" typeId="9b8f-694b-e5e-b573">1. Add 2” to the Move characteristic of models in this unit. 2. Add 1 to Advance and Charge rolls made for this unit.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
            </selectionEntry>
...
2. Each time this unit makes a Normal, Advance, or Charge move it can move over terrain features as if they were not there. It may not end its movement inside of a wall etc. If it does roll a D6: on a 1 or 2 this unit takes D3 Mortal Wounds.</characteristic>
            ...
            <selectionEntry type="upgrade" import="true" name="Berserking Armor" OldName="Focused Gunners" hidden="false" id="e5f2-bcf2-5c6b-0012">
              <constraints>
...
2. If you target this unit with the Tank shock Stratagem it can roll two extra dice.</characteristic>
            ...
            <selectionEntry type="upgrade" import="true" name="Tank Hunter" oldName="Reinforced Superstructure" hidden="false" id="889a-143f-85b7-318f">
              <constraints>
...
2. Each time a model in this unit makes an attack that targets a Monster or Vehicle unit, add 1 to the Wound roll.</characteristic>
            ...
            <selectionEntry type="upgrade" import="true" name="Unrelenting Optics" oldName="Elite Crew" hidden="false" id="1fff-1aa9-7fc9-6295">
              <constraints>
...
2. If this unit is targeted with the Fire Overwatch Statagem it hits on 5+.</characteristic>
            ...
            <selectionEntry type="upgrade" import="true" name="Blessed Hull" oldName="Auto-repair Nodes" hidden="false" id="f09a-6b41-483c-147e">
              <constraints>
...
2. Add one to Advance rolls for models in this unit.</characteristic>
            ...
            <selectionEntry type="upgrade" import="true" name="Resolute Veterans" oldName="Headhunters" hidden="false" id="8c3a-90c3-e11b-4329">
              <constraints>
...
2. Each time this unit Advances, do not make an Advance roll for it. Instead, until the end of the phase, add 6" to the Move characteristic of models in this unit.</characteristic>
              ...
              <modifierGroups>
                <modifierGroup type="and">
                  <modifiers>
                    <modifier type="append" value="Sleek Interceptors" field="annotation" join=", " scope="model" affects="self.entries.recursive.profiles.Unit"/>
                    <modifier type="increment" value="2" field="e703-ecb6-5ce7-aec1" scope="model" affects="self.entries.recursive.profiles.Unit" join=", "/>
                  </modifiers>
                </modifierGroup>
              </modifierGroups>
...
2. This unit cannot be targeted by ranged attacks unless the attacking unit is within 18”.</characteristic>
        ...
        <comment>Ferrus Crusade Battle Traits End</comment>    \
        <!-- ********************************************************************************************** -->
        <!-- ********************************************************************************************** -->
        <!-- ********************************************************************************************** -->
        <!-- ********************************************************************************************** -->
